$(document).ready(function(){
    ...
    */
    ...
    $(document).keydown(function(e) {
        switch(e.which) {
            ...
            _jumping(jumping, 50, 10 );
             // _jumping(jumping, sec, px);
            break;

            case 40: // down
            current_animation = running;
            _motion(running, 50, 20);
            // motion(running);
            break;
    ...
    */
    ...
    function _motion(action, seconds, pixels) {
        ...
        _animation(action);
        // gets repeated on 2 loops.. _mortion and _xaxis. if called seperatly works.
        if(trigger == true) {
            trigger = false;
    ...
    function _secPerPx(seconds, pixels) {
        return((parseInt(seconds)/parseInt(pixels))*20);
    }
    ...
    function _yaxis(seconds, pixels) {
        ...
        pixels = pixels-2; 
        $('#redman').css('bottom', (parseInt(yaxis)+(parseInt(pixels)))+'px');
    }
